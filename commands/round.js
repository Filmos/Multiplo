function parse(state, args, report) {
  ...
  if(isNaN(parseFloat(a1))) return report.error('Error in round snippet: "'+a1+'" is not a number')
  a1 = parseFloat(a1)
  ...
  if(isNaN(parseFloat(a2))) return report.error('Error in round snippet: "'+a2+'" is not a number')
  a2 = parseFloat(a2)
